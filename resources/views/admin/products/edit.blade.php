            ...
            <form method="POST" action="{{ route('admin.products.update', $product) }}" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="description" rows="4"
                        class="w-full rounded-2xl border border-gray-200 px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ old('description', $product->description) }}</textarea>
